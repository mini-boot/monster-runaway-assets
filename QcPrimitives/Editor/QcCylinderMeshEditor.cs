...
namespace QuickPrimitives
{
    ...
    public class QcCylinderMeshEditor : Editor
    {
        ...
        //private static int saveNumSides = 0;
        ...
        override public void OnInspectorGUI()
        {
            ...
            mesh.properties.sides =
                            EditorGUILayout.IntSlider("Sides", mesh.properties.sides, 1, 64);
            //if (mesh.properties.sides != 1)
            //{
            //    mesh.properties.sides =
            //                EditorGUILayout.IntSlider("Sides", mesh.properties.sides, 8, 64);
            //    saveNumSides = mesh.properties.sides;       // restore sides count
            //}

            mesh.properties.faceNormals = EditorGUILayout.Toggle("Segmented Sides", mesh.properties.faceNormals);
            //if (mesh.properties.faceNormals)
            //{
            //    mesh.properties.sides = 1;
            //}
            //else
            //{
            //    mesh.properties.sides = saveNumSides;       // record sides count
            //}
