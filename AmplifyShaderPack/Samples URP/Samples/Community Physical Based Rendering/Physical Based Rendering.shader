	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				output.ase_texcoord4.xy = vertexToFrag795_g1;
				...
				output.ase_texcoord8.xy = input.ase_texcoord2.xy;
				 ...
				 ) : SV_Target
			{
				...
				float2 vertexToFrag795_g1 = input.ase_texcoord4.xy;
				...
				float3 bakedGI607_g1 = ASEBakedGI( WorldPosition, WorldNormalTangent1160_g1, ( uint2 )( ase_screenPosNorm.xy * _ScreenSize.xy ), (input.ase_texcoord4.zw*(unity_LightmapST).xy + (unity_LightmapST).zw), (input.ase_texcoord8.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw), true);
				...
				float3 Indirect_Diffuse644_g1 = ( ( ( ( localAdditionalLightsHalfLambert17x172_g61278 + bakedGI607_g1 ) * _IndirectDiffuse ) * Occlusion435_g1 ) * GetCurrentExposureMultiplier() );
...
ASEEND*/
//CHKSM=896B8A9E0EB35AB6A746503EFE55541AF7FA5A55