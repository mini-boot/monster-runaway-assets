	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float4 appendResult704_g13 = (float4(cross( input.normalOS , float3(0,0,1) ) , -1.0));
				
				float2 break291_g13 = _Control_ST.zw;
				float2 appendResult293_g13 = (float2(( break291_g13.x + 0.001 ) , ( break291_g13.y + 0.0001 )));
				float2 vertexToFrag286_g13 = ( ( input.texcoord.xy * _Control_ST.xy ) + appendResult293_g13 );
				output.ase_texcoord9.xy = vertexToFrag286_g13;
				float2 vertexToFrag851_g13 = ( ( input.texcoord.xy * (_SnowMainUVs).xy ) + (_SnowMainUVs).zw );
				output.ase_texcoord10.xy = vertexToFrag851_g13;
				...
				input.tangentOS = appendResult704_g13;
						 ...
						 ) : SV_Target
			{
				...
				float2 vertexToFrag286_g13 = input.ase_texcoord9.xy;
				...
				float2 vertexToFrag851_g13 = input.ase_texcoord10.xy;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 break291_g13 = _Control_ST.zw;
				float2 appendResult293_g13 = (float2(( break291_g13.x + 0.001 ) , ( break291_g13.y + 0.0001 )));
				float2 vertexToFrag286_g13 = ( ( input.ase_texcoord.xy * _Control_ST.xy ) + appendResult293_g13 );
				output.ase_texcoord3.xy = vertexToFrag286_g13;
						 ...
						 ) : SV_TARGET
			{
				...
				float2 vertexToFrag286_g13 = input.ase_texcoord3.xy;
				float4 tex2DNode283_g13 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g13 );
				float dotResult278_g13 = dot( tex2DNode283_g13 , half4(1,1,1,1) );
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 break291_g13 = _Control_ST.zw;
				float2 appendResult293_g13 = (float2(( break291_g13.x + 0.001 ) , ( break291_g13.y + 0.0001 )));
				float2 vertexToFrag286_g13 = ( ( input.texcoord0.xy * _Control_ST.xy ) + appendResult293_g13 );
				output.ase_texcoord4.xy = vertexToFrag286_g13;
				float2 vertexToFrag851_g13 = ( ( input.texcoord0.xy * (_SnowMainUVs).xy ) + (_SnowMainUVs).zw );
				output.ase_texcoord5.xy = vertexToFrag851_g13;
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 vertexToFrag286_g13 = input.ase_texcoord4.xy;
				float4 tex2DNode283_g13 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g13 );
				float dotResult278_g13 = dot( tex2DNode283_g13 , half4(1,1,1,1) );
				float localSplatClip276_g13 = ( dotResult278_g13 );
				float SplatWeight276_g13 = dotResult278_g13;
				...
				float4 appendResult723_g13 = (float4(( tex2DNode717_g13.r * _SnowSplatRSplatBias ) , ( tex2DNode717_g13.g * _SnowSplatGSplatBias ) , ( tex2DNode717_g13.b * _SnowSplatBSplatBias ) , ( tex2DNode717_g13.a * _SnowSplatASplatBias )));
				float4 SnowSplatRGBA728_g13 = appendResult723_g13;
				float2 vertexToFrag851_g13 = input.ase_texcoord5.xy;
				float2 temp_output_850_0_g13 = ( vertexToFrag851_g13 * 100.0 );
				float3 temp_output_12_0_g14 = (SAMPLE_TEXTURE2D( _SnowMapBaseColor, sampler_SnowMapBaseColor, temp_output_850_0_g13 )).rgb;
				float dotResult28_g14 = dot( float3(0.2126729,0.7151522,0.072175) , temp_output_12_0_g14 );
				float3 temp_cast_1 = (dotResult28_g14).xxx;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 appendResult293_g13 = (float2(( break291_g13.x + 0.001 ) , ( break291_g13.y + 0.0001 )));
				float2 vertexToFrag286_g13 = ( ( input.ase_texcoord.xy * _Control_ST.xy ) + appendResult293_g13 );
				output.ase_texcoord2.xy = vertexToFrag286_g13;
				float2 vertexToFrag851_g13 = ( ( input.ase_texcoord.xy * (_SnowMainUVs).xy ) + (_SnowMainUVs).zw );
				output.ase_texcoord3.xy = vertexToFrag851_g13;
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 vertexToFrag286_g13 = input.ase_texcoord2.xy;
				float4 tex2DNode283_g13 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g13 );
				float dotResult278_g13 = dot( tex2DNode283_g13 , half4(1,1,1,1) );
				float localSplatClip276_g13 = ( dotResult278_g13 );
				float SplatWeight276_g13 = dotResult278_g13;
				...
				float4 appendResult723_g13 = (float4(( tex2DNode717_g13.r * _SnowSplatRSplatBias ) , ( tex2DNode717_g13.g * _SnowSplatGSplatBias ) , ( tex2DNode717_g13.b * _SnowSplatBSplatBias ) , ( tex2DNode717_g13.a * _SnowSplatASplatBias )));
				float4 SnowSplatRGBA728_g13 = appendResult723_g13;
				float2 vertexToFrag851_g13 = input.ase_texcoord3.xy;
				float2 temp_output_850_0_g13 = ( vertexToFrag851_g13 * 100.0 );
				float3 temp_output_12_0_g14 = (SAMPLE_TEXTURE2D( _SnowMapBaseColor, sampler_SnowMapBaseColor, temp_output_850_0_g13 )).rgb;
				float dotResult28_g14 = dot( float3(0.2126729,0.7151522,0.072175) , temp_output_12_0_g14 );
				float3 temp_cast_1 = (dotResult28_g14).xxx;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 appendResult293_g13 = (float2(( break291_g13.x + 0.001 ) , ( break291_g13.y + 0.0001 )));
				float2 vertexToFrag286_g13 = ( ( input.ase_texcoord.xy * _Control_ST.xy ) + appendResult293_g13 );
				output.ase_texcoord5.xy = vertexToFrag286_g13;
				float2 vertexToFrag851_g13 = ( ( input.ase_texcoord.xy * (_SnowMainUVs).xy ) + (_SnowMainUVs).zw );
				output.ase_texcoord6.xy = vertexToFrag851_g13;
						 ...
						 )
			{
				...
				float2 vertexToFrag286_g13 = input.ase_texcoord5.xy;
				float4 tex2DNode283_g13 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g13 );
				float dotResult278_g13 = dot( tex2DNode283_g13 , half4(1,1,1,1) );
				float localSplatClip276_g13 = ( dotResult278_g13 );
				float SplatWeight276_g13 = dotResult278_g13;
				...
				float4 appendResult723_g13 = (float4(( tex2DNode717_g13.r * _SnowSplatRSplatBias ) , ( tex2DNode717_g13.g * _SnowSplatGSplatBias ) , ( tex2DNode717_g13.b * _SnowSplatBSplatBias ) , ( tex2DNode717_g13.a * _SnowSplatASplatBias )));
				float4 SnowSplatRGBA728_g13 = appendResult723_g13;
				float2 vertexToFrag851_g13 = input.ase_texcoord6.xy;
				float2 temp_output_850_0_g13 = ( vertexToFrag851_g13 * 100.0 );
				float3 unpack856_g13 = UnpackNormalScale( SAMPLE_TEXTURE2D( _SnowMapNormal, sampler_SnowMapNormal, temp_output_850_0_g13 ), _SnowNormalStrength );
				unpack856_g13.z = lerp( 1, unpack856_g13.z, saturate(_SnowNormalStrength) );
				float3 SnowNormal858_g13 = unpack856_g13;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction(Attributes input  )
			{
				...
				float2 appendResult293_g13 = (float2(( break291_g13.x + 0.001 ) , ( break291_g13.y + 0.0001 )));
				float2 vertexToFrag286_g13 = ( ( input.ase_texcoord.xy * _Control_ST.xy ) + appendResult293_g13 );
				output.ase_texcoord.xy = vertexToFrag286_g13;
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float2 vertexToFrag286_g13 = input.ase_texcoord.xy;
				float4 tex2DNode283_g13 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g13 );
				float dotResult278_g13 = dot( tex2DNode283_g13 , half4(1,1,1,1) );
...
ASEEND*/
//CHKSM=1C2B0D73626C158715C4E3DCF87C633086ABC884