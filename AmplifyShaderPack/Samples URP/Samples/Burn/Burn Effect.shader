	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord180 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord179 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 texCoord180 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode80 = tex2D( _Albedo, texCoord180 );
				float4 temp_cast_0 = (0.0).xxxx;
				float2 panner9 = ( _BurnOffset * float2( 1,0.5 ) + ( texCoord180 * _BurnTilling ));
				float4 tex2DNode98 = tex2D( _Masks, panner9 );
				float temp_output_19_0 = ( _CharcoalMix + tex2DNode98.r );
				float4 lerpResult28 = lerp( ( tex2DNode80 * _AlbedoMix ) , temp_cast_0 , temp_output_19_0);
				float2 texCoord179 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode83 = tex2D( _BurntTileNormals, ( texCoord179 * _CharcoalNormalTile ) );
				float4 lerpResult148 = lerp( ( float4(0.718,0.0627451,0,1) * ( tex2DNode83.a * 2.95 ) ) , ( float4(0.647,0.06297875,0,1) * ( tex2DNode83.a * 4.2 ) ) , tex2DNode98.g);
				float4 lerpResult152 = lerp( lerpResult28 , ( ( lerpResult148 * tex2DNode98.r ) * _BaseEmber ) , ( tex2DNode98.r * 1.0 ));
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 texCoord180 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode80 = tex2D( _Albedo, texCoord180 );
				float4 temp_cast_0 = (0.0).xxxx;
				float2 panner9 = ( _BurnOffset * float2( 1,0.5 ) + ( texCoord180 * _BurnTilling ));
				float4 tex2DNode98 = tex2D( _Masks, panner9 );
				float temp_output_19_0 = ( _CharcoalMix + tex2DNode98.r );
				float4 lerpResult28 = lerp( ( tex2DNode80 * _AlbedoMix ) , temp_cast_0 , temp_output_19_0);
				float2 texCoord179 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode83 = tex2D( _BurntTileNormals, ( texCoord179 * _CharcoalNormalTile ) );
				float4 lerpResult148 = lerp( ( float4(0.718,0.0627451,0,1) * ( tex2DNode83.a * 2.95 ) ) , ( float4(0.647,0.06297875,0,1) * ( tex2DNode83.a * 4.2 ) ) , tex2DNode98.g);
				float4 lerpResult152 = lerp( lerpResult28 , ( ( lerpResult148 * tex2DNode98.r ) * _BaseEmber ) , ( tex2DNode98.r * 1.0 ));
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 texCoord179 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode83 = tex2D( _BurntTileNormals, ( texCoord179 * _CharcoalNormalTile ) );
				float4 appendResult182 = (float4(1.0 , tex2DNode83.g , 0.0 , tex2DNode83.r));
				float2 texCoord180 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner9 = ( _BurnOffset * float2( 1,0.5 ) + ( texCoord180 * _BurnTilling ));
				float4 tex2DNode98 = tex2D( _Masks, panner9 );
				float temp_output_19_0 = ( _CharcoalMix + tex2DNode98.r );
				float3 lerpResult103 = lerp( UnpackNormalScale( tex2D( _Normals, texCoord179 ), 1.0f ) , UnpackNormalScale( appendResult182, 1.0 ) , temp_output_19_0);
...
ASEEND*/
//CHKSM=16DD217C0808AFA7E86694C979426082AF0FFB70