    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                ...
                UNITY_DEFINE_INSTANCED_PROP( float, _Top_Layer_Pos)
                UNITY_DEFINE_INSTANCED_PROP( float, _Top_Layer_Smooth)
...
/////// Diffuse:
                ...
                float4 _Color_4_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Color_4 );
                ...
                float3 Color_2 = _Color_2_var.rgb;
                float4 _Color_1_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Color_1 );
                float node_9160 = 0.99;
                float node_1487 = 1.03;
                float _Top_Color_Blend_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Top_Color_Blend );
                float3 node_5234 = ((NormalMap_Strength_2( node_6193 , _Top_Color_Blend_var )*0.1)+i.vertexColor.rgb);
                float _Top_Layer_Pos_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Top_Layer_Pos );
                float node_5724 = (1.0 - _Top_Layer_Pos_var);
                float _Top_Layer_Smooth_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Top_Layer_Smooth );
                float node_562 = (node_5724-_Top_Layer_Smooth_var);
                float node_6345 = (node_5724+_Top_Layer_Smooth_var);
                float3 diffuseColor = lerp((((1.0 - saturate(((((node_335.rgb*node_1854)+(_AO_Texture_2.rgb*node_9234))+(_AO_Texture_3.rgb*node_6298))+(1.0 - _AO_Intensity_var))))*_Color_2_var.rgb)+lerp(_Color_4_var.rgb,_Color_3_var.rgb,smoothstep( (_Rock_Color_Pos_var-_Rock_Color_Smooth_var), (_Rock_Color_Pos_var+_Rock_Color_Smooth_var), i.vertexColor.r ))),lerp(Color_2,_Color_1_var.rgb,smoothstep( float3(node_9160,node_9160,node_9160), float3(node_1487,node_1487,node_1487), node_5234 )),smoothstep( float3(node_562,node_562,node_562), float3(node_6345,node_6345,node_6345), node_5234 ));
