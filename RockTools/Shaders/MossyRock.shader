    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                ...
                UNITY_DEFINE_INSTANCED_PROP( float, _Moss_Amount)
                UNITY_DEFINE_INSTANCED_PROP( float, _Moss_Edge_Smooth)
                ...
                UNITY_DEFINE_INSTANCED_PROP( float4, _Moss_Color_2)
                UNITY_DEFINE_INSTANCED_PROP( float4, _Moss_Color_1)
...
/////// Diffuse:
                ...
                float4 _Moss_Color_2_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Moss_Color_2 );
                float4 _Moss_Color_1_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Moss_Color_1 );
                float node_6722 = ((NormalMap_Strength_2( node_6193 , 1.5 )*0.1)+i.vertexColor.rgb).r;
                float _Moss_Amount_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Moss_Amount );
                float node_5724 = (1.0 - _Moss_Amount_var);
                float _Moss_Edge_Smooth_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Moss_Edge_Smooth );
                float3 diffuseColor = lerp((node_813*lerp(_Rock_Bottom_Color_var.rgb,_Rock_Top_Color_var.rgb,smoothstep( (_Rock_Color_Pos_var-_Rock_Color_Smooth_var), (_Rock_Color_Pos_var+_Rock_Color_Smooth_var), i.vertexColor.r ))),lerp(_Moss_Color_2_var.rgb,_Moss_Color_1_var.rgb,smoothstep( 0.99, 1.03, node_6722 )),smoothstep( (node_5724-_Moss_Edge_Smooth_var), (node_5724+_Moss_Edge_Smooth_var), node_6722 ));
