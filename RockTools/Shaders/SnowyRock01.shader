    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                ...
                UNITY_DEFINE_INSTANCED_PROP( float4, _Snow_Color)
                UNITY_DEFINE_INSTANCED_PROP( float, _AO_Intensity)
                UNITY_DEFINE_INSTANCED_PROP( float, _Snow_Dir_X)
                UNITY_DEFINE_INSTANCED_PROP( float, _Snow_Dir_Y)
                UNITY_DEFINE_INSTANCED_PROP( float, _Snow_Dir_Z)
...
/////// Diffuse:
                ...
                float4 _Snow_Color_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Snow_Color );
                ...
                float _Snow_Dir_X_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Snow_Dir_X );
                float _Snow_Dir_Y_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Snow_Dir_Y );
                float _Snow_Dir_Z_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Snow_Dir_Z );
                ...
                float3 diffuseColor = lerp((saturate(((((node_335.rgb*node_1854)+(_AO_Texture_2.rgb*node_9234))+(_AO_Texture_3.rgb*node_6298))+(1.0 - _AO_Intensity_var)))*lerp(_Rock_Bottom_Color_var.rgb,_Rock_Top_Color_var.rgb,smoothstep( (_Rock_Color_Pos_var-_Rock_Color_Smooth_var), (_Rock_Color_Pos_var+_Rock_Color_Smooth_var), i.vertexColor.r ))),_Snow_Color_var.rgb,smoothstep( (node_5724-_Snow_Edge_Smooth_var), (node_5724+_Snow_Edge_Smooth_var), saturate(dot(normalize(Vector3( _Snow_Dir_X_var , _Snow_Dir_Y_var , _Snow_Dir_Z_var )),((NormalMap_Strength_1( (((node_5175.rgb*node_1854)+(_Normal_Map_2.rgb*node_9234))+(_Normal_Map_3.rgb*node_6298)) , 1.5 )*0.85)+i.normalDir))) ));
